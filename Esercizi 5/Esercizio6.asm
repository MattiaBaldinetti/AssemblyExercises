...
# costruire una nuova stringa in cui il primo carattere di ciascuna parola nella frase di partenza 
# è stato reso maiuscolo. Tutti gli altri caratteri devono essere resi minuscoli. 
...
CICLO:
	...
	ble $t1,$t7,SPAZIO 	# SE IL VALORE IN t1 E' MINORE O UGUALE AL VALORE IN t7 VADO IN SPAZIO
	bge $t1,$t9 SALVATAGGIO # SE IL VALORE IN t1 E' MAGGIORE DEL VALORE IN t9 VADO IN SALVATAGGIO
	add $t1,$t1,$t6 	# ALTRIMENTI AGGIUNGO AL VALORE IN UPPER LA DIFFERENZA FRA UPPER E LOWER(32)
